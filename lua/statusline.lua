...
hi("StatusMode", { guibg = palette.green, guifg = palette.bg_dark, gui = "bold" })
...
hi("StatusInfoIcon", { guibg = NONE, guifg = palette.cyan, gui = "bold" })

hi("StatusHintIcon", { guibg = NONE, guifg = palette.muted })

hi("StatusBuffer", { guibg = palette.bg_highlight, guifg = palette.fg })

hi("StatusType", { guibg = palette.bg_highlight, guifg = palette.fg })

hi("StatusTypeToNorm", { guibg = NONE, guifg = palette.fg })

hi("StatusNorm", { guibg = NONE, guifg = NONE })

hi("StatusLocation", { guibg = palette.purple, guifg = palette.bg_dark })

hi("StatusPercent", { guibg = palette.cyan, guifg = palette.bg_dark, gui = "bold" })
