...
-- NOTE: this neovim nightly ships NO builtin LSP server configs (runtime/lsp/ is
-- empty), so every enabled server needs a complete config here: cmd, filetypes
-- and root resolution. Binaries come from the Nix-provided PATH.
...
vim.lsp.config("basedpyright", {
  ...
  root_markers = {
    ...
    "tox.ini", "pyrightconfig.json", ".git",
  },
})
